...
foreach($studentDetails as $row)
{
	...
	if($section2 == '2')
	{
		...
		$html .= '<table cellspacing="0" style="width:100%;border: 1px solid #0c3d03;">
					...
					<table cellspacing="0" cellpadding="0" style="width: 100%; border: 0px solid #0c3d03; border-collapse: collapse;">
						<tr style="border: 0px solid #0c3d03;">
							<td class="data_top1" rowspan="2" style="width:15%;">
								<p class="data_top2">
									<span class="data_top3" style="font-size:12px;width:35%;word-break: break-all !important;">SUBJECTS</span>
								</p>
							</td>
		...
		foreach($exam_codes_arr1 AS $examheaderdispaly)
		{
			$html.= '<td  class="data_top1">
						<p class="data_top2">
							<span class="data_top3" style="width:'.$dynamic_widith.'%;font-size:12px !important;">'.$examheaderdispaly->exam_name.'<br> ( '.$examheaderdispaly->weightage.' )</span>
						</p>
					</td>';
			...
			if(sizeof($term1_rc_exammapped_array) == $mapped_exam_count)
			{
				...
				$html .= '<td  class="data_top1" >
                    ...
                    <td  class="data_top1" style="width:11%">
						<p class="data_top2">
							<span class="data_top3" style="width:11%;font-size:18px !important;">Grade</span>
						</p>
					</td>';
			}
			$mapped_exam_count++;
	...
	if($section4 == '4')
	{
		// 2 for term 1 (marks obtained and grade) and 1 for subject coulmn
		$col_count = sizeof($exam_codes_arr1)+3;
		if($grades)
		{
			for($i=0;$i<count($grades);$i=$i+$col_count)
			{
				...
				for($j=$lastcol_index-$col_count; $j < $lastcol_index; $j++)
				{
					...
					if($f == 0)
					{
						...
						$styled = ' style="font-size:12px;word-break: break-all !important;"';
					}
					else
					{
					...
					<p class="data_top2"><span class="data_top3" '.$styled.'>xx'.$dispaly_secured_mark.'</span></p>
					</td>';
	...
	if($section5 == '5')
	{
		$html .= '<table cellspacing="0" style="width:100%;border: 1px solid #0c3d03;margin:5px 0px 5px 0px;">
			<tr>
